...
public class AuditControllerTest {
    ...
    @Test
    public void getTransactionAudits() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/admin/audit/get")
    ...
    @Test
    public void auditPass() throws Exception {
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/admin/audit/pass")
                .contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void auditRefuse() throws Exception {
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/admin/audit/refuse")
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(JSON.toJSONString(new HashMap<>()))
                .accept(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk())
